...
const postTypeName: { [type in AnalysisType]: GetTranslationFunction } = {
  [AnalysisType.CHARACTER]: (t) => t.posts.analysis.type.character,
  [AnalysisType.DRAGON]: (t) => t.posts.analysis.type.dragon,
};
