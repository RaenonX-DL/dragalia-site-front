...
export const translation: TranslationStruct = {
  ...
  googleSignin: {
    ...
    notLoaded: '読み込みに失敗しました。サードパーティのCookieを有効にしもう一度お試しください。',
    login: 'Googleアカウントログイン',
    loginError: 'エラー: {{error}} - {{details}}',
    loginFailed: 'ログイン失敗',
    loginUnknown: '不明なエラーが発生。ログインに失敗しました。({{error}})',
    loginOfflineDisallowed: 'オフラインログインはできません。サイト管理者までお問い合わせください。',
    logout: 'Googleアカウントログアウト',
    logoutFailed: 'ログアウト失敗',
    logoutUnknown: '不明なエラーが発生。ログアウトに失敗しました。',
    requestFailed: 'ログインのリクエスト送信に失敗しました。',
  },
  lang: {
    inUse: '使用中',
  },
  message: {
    ...
    alert: {
      ads: '毎月わずかな寄付をしていただけると、広告なしでご利用できます！[詳細はこちら](/thanks)',
      migration: 'サイトの基盤をリニューアル中です。もし問題を見つけましたらSNSなどでご連絡をお願いします。',
    },
  },
  misc: {
    add: '追加',
