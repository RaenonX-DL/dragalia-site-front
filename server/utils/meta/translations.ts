import {GeneralPath, PagePath, PostPath} from '../../../src/const/path/definitions';
import {PageMetaTranslations} from '../../../src/i18n/translations/definition';
import {GetTranslationFunction} from '../../../src/i18n/types';

export const transFunctions: { [path in PagePath]: GetTranslationFunction<PageMetaTranslations> } = {
  // In-production paths
  ...
  [GeneralPath.ANALYSIS_LIST]: (t) => t.meta.inUse.analysisList,
